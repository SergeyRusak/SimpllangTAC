...
public class SimpllangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "ID", "NUM", "BOOL", "STRING", "ASTERISK", 
			"SLASH", "PLUS", "MINUS", "AND", "OR", "EQUAL", "NOT_EQUAL", "LESS", 
			"LESS_OR_EQUAL", "GREATER", "GREATER_OR_EQUAL", "SPACE", "COMMENT", "LINE_COMMENT"
		};
	}
	...
	public SimpllangLexer(CharStream input) {
		super(input);
